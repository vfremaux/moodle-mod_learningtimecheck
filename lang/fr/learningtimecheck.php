...
$string['completionpercent'] = 'Pourcentage d\'éléments non obligatoires marqués attendu';
$string['completionpercentgroup'] = 'Nécessite un marquage';
$string['completionmandatory'] = 'Pourcentage d\'éléments obligatoires marqués attendu';
$string['completionmandatorygroup'] = 'Nécessite un marquage';
...
$string['configdefaultconsidergrades'] = 'Prendre en compte les notes de réussite dans les achèvements (default)';
$string['configdefaultconsidergrades_desc'] = 'Si actif, alors les reports d\'état d\'achèvement tiendront compte de la note de passage.';
...
$string['totalcourseratio'] = 'Couverture du cours (en temps)';
...
$string['configinitiallymandatory_desc'] = 'Si marqué, tous les éléments découverts dans les cours seront marqués comme obligatoires.
Sinon, tous les éléments créés automatiquement seront initalement marqués comme facultatifs';
...
$string['configshowcompletemymoodle_desc'] = 'Si cette option est activée, alors les listes complétée ne seront pas visible dans les
pages personnalisées';

$string['configshowmymoodle_desc'] = 'Si cette option est activée, alors les listes de progression et leurs barres ne seront pas visible
dans les pages personnalisées';

$string['configcouplecredittomandatoryoption_desc'] = 'Si actif, un item de liste deviendra obligatoire lorsqu\'on lui affecte un crédit
temps pédagogique non nul';

$string['configcsvfieldseparator_desc'] = 'Séparateur de champ CSV';

$string['configallowoverrideusestats_desc'] = 'Si activé, il est possible de déclarer certains items pour que leur crédit temps remplace
la valeur "mesurée" dans les rapports de session de formation.';

$string['configlastcompiled_desc'] = 'Changer cette date recompilera les événements non pris en compte.';

$string['configautoupdateusecron_desc'] = 'Si activé, la mise à jour automatique des marques est réalisée par les taches planifiées de Moodle,
avec un certain retard. Si vous pouvez supporter ce délai, cela évite que les marques soient calculées pendant que vous naviguez dans les
interfaces de la liste de temps pédagogique, ce qui peut rallentir celles-ci notablement.';

$string['configapplyfiltering_desc'] = 'Si activé, le fitlrage de jours et heures ouvrées des rapports de temps d\'apprentissage
s\'appliquent aux marques générées par la liste. Sinon, le module de temps d\'apprentissage n\'est pas affecté par le filtrage
(Sans ipact sur les rapports de session qui continuent à subir le fltrage.).';
...
Les temps validés sont inscrits comme tels dans les rapports de Session de Formation (rapport non standard) lié au bloc Mesure d\'Activité.

L\'usage de ce module permet de dissocier la notion d\'accomplissement des objectifs pédagogiques et règles de poursuite outillées par la notion
d\'achèvement du cours, de la notion de comptabilité de temps pédagogique souvent lié à des questions de financement de la formation.
';
...
<p>Une fois synchronisée avec le cours, la liste subira tous les changements qui sont faits dans le cours ou la section, quelles que soient
vos actions dans le panneau d\'édition des éléments de liste.</p>
...
<p>Pour retirer les activités d\'une liste de marquage, vous devez remettre cette option à "Non", puis aller sur le panneau d\'édition
des éléments de liste et cliquer sur le bouton "Enlever les activités du cours".</p>
';
...
<p>"Compléter" une activité peut dépendre du type d\'activité - la voir pour une ressource, soumettre un fichier pour un devoir, poster un
premier message dans un forum, ou rejoindre la première fois un chat, etc.</p>
<p>Si vous souhaitez des détails sur l\'événement qui "complète" une activité particulière, demandez à votre administrateur de regarder le
fichier "mod/learningtimecheck/autoupdatelib.php"</p>
<p><strong>Note :</strong> La mise à jour des marques automatique dépend du passage de la tâche régulière de mise à jour de Moodle. Il
est possible que cette mise à jour puisse prendre plusieurs minutes, selon le réglage de la fréquence de cette tâche. L\'administrateur peut
effectuer quelques modifications non standard de Moodle pour rendre cette mise à jour immédiate.</p>
';

$string['emailoncomplete_help'] = '
<p>Quand une liste est compléte (l\'étudiant a coché tous les éléments de la liste ou effectué les activités demandées dans le cas où seul
l\'étudiant est concerné, ou l\'enseignant a coché l\'ensemble des éléments, un courriel de notification est envoyé à tous les enseignants du cours.</p>
<p>Un administrateur peut décider qui reçoit ce courriel en utilisant la capacité "mod:learningtimecheck/emailoncomplete" - par défaut, tous
les enseignants et non enseignants non éditeur ont cette capacité.</p>
';
