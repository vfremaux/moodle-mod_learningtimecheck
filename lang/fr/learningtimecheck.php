...
$string['configcsvencodingdesc'] = 'Encodage du fichier CSV';
$string['configcsvfieldseparator'] = 'Séparateur de champ';
$string['configcsvfieldseparatordesc'] = 'Séparateur de champ CSV';
$string['configcsvlineseparator'] = 'Fin de ligne';
$string['configcsvlineseparatordesc'] = 'Fin de ligne CSV';
...
$string['configshowcompletemymoodledesc'] = 'Si cette option est activée, alors les listes complétée ne seront pas visible dans les pages personnalisées';
$string['configshowmymoodle'] = 'Montrer les listes d\'avancement sur les pages personnalisées';
$string['configshowmymoodledesc'] = 'Si cette option est activée, alors les listes de progression et leurs barres ne seront pas visible dans les pages personnalisées';
...
$string['doneitems'] = 'Items réalisés';
...
$string['enablecreditdesc'] = ' (*) si activé, le crédit temps est imposé dans les rapports de session de formation (add-on) au lieu du temps constaté.';
...
$string['itemstodo'] = 'Items à réaliser';
...
$string['view_withoutlinks'] = 'Vue en blocs (étudiants) sans liens';
