...
require_once($CFG->dirroot.'/mod/learningtimecheck/lib.php'); // to get xx_supports_feature();
if ('pro' == learningtimecheck_supports_feature()) {
    include($CFG->dirroot.'/mod/learningtimecheck/pro/lang/fr/pro.php');
}
