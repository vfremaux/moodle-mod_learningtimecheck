...
$string['configdefaultconsidergrades'] = 'Consider completion pass grades (default)';
$string['configdefaultconsidergrades_desc'] = 'If enabled, any change in completion will be reported in LTC states considerong pass/fail grade.';
