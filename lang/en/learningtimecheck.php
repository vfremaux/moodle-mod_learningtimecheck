...
$string['configcsvencodingdesc'] = 'CSV file encoding';
$string['configcsvfieldseparator'] = 'CSV field separator';
$string['configcsvfieldseparatordesc'] = 'CSV field separator';
$string['configcsvlineseparator'] = 'CSV line separator';
$string['configcsvlineseparatordesc'] = 'CSV line separator';
...
$string['configshowcompletemymoodledesc'] = 'If this is unchecked then completed checklist  will be hidden from the \'My Moodle\' page';
$string['configshowmymoodle'] = 'Show checklist  on \'My Moodle\' page';
$string['configshowmymoodledesc'] = 'If this is unchecked then checklist activities (with progress bars) will no longer appear on the \'My Moodle\' page';
...
$string['enablecreditdesc'] = ' (*) If enabled, this time will be used in Training Session Report (add-on), in place of the measured time from user logs.';
...
$string['view_withoutlinks'] = 'View as blocks with no links';
