...
if (!class_exists('MoodleQuickForm_elementgrid')){
    if (file_exists($CFG->libdir.'/pear/HTML/QuickForm/elementgrid.php')){
        ...
        require_once($CFG->dirroot."/mod/learningtimecheck/__other/HTML/QuickForm/elementgrid.php");
    }
 ...
 */
    ...
    if (file_exists($CFG->libdir.'/form/elementgrid.php')){
        ...
        MoodleQuickForm::registerElementType('elementgrid', $CFG->dirroot.'/mod/learningtimecheck/__other/elementgrid.php', 'MoodleQuickForm_elementgrid');
    }
}