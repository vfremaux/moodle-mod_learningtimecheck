...
$ltcid  = optional_param('ltc', 0, PARAM_INT); // Learningtimecheck instance ID.
...
$PAGE->set_url('/mod/learningtimecheck/pro/coursetutorboard.php', $params);
...
if ($id) {
    ...
    if (! $learningtimecheck = $DB->get_record('learningtimecheck', array("id" => $ltcid))) {
        print_error('invalidlearningtimecheckid', 'learningtimecheck');
    }
...
$ltc = new learningtimecheck_class($cm->id, $USER->id, $learningtimecheck, $cm, $course);

if (!$ltc->canviewtutorboard()) {
